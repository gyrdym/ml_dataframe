...
abstract class DataFrame implements Serializable {
  ...
  /// void main() {
  ///   final series = [
  ///     Series('some_series', [10, 20, 30]),
  ///     Series('super_series', [20, 40, 60]),
  ///     Series('awesome_series', [30, 80, 90]),
  ///   ];
  ///   final dataframe = DataFrame.fromSeries(series);
  ///
  ///   print(dataframe);
  ///
  ///   // DataFrame (3 x 3)
  ///   // some_series super_series awesome_series
  ///   //          10           20             30
  ///   //          20           40             80
  ///   //          30           60             90
  /// }
  ...
  ///
  /// [header] A header row for the [DataFrame] instance. If no [header]
  /// provided, the row will be autogenerated
  ///
  /// [autoHeaderPrefix] A string that will be used as a prefix of a column
  /// name in case of autogenerated header row. Default value is `col_`
  ///
  /// [columns] Column indices to pick from the [matrix]
  ///
  /// [discreteColumns] Column indices with discrete values. The information
  /// about discrete columns will be used for [Series] - to understand what is
  /// discrete data, please refer to [Series] documentation
  ///
  /// A usage example:
  ///
  /// ```dart
